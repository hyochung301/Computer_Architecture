...
int translate(char* opcode, char* arg1, char* arg2, char* arg3, char* arg4, int startAddr, int currentAddr){
...
int pass2(char* input_file, char* output_file) {
    /* second pass */
    printf("second pass\n");
